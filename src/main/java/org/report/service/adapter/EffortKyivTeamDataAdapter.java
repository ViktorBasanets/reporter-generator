...
public class EffortKyivTeamDataAdapter extends BaseEffortDataAdapter implements DataAdapter<EffortTeamData> {
    @Override
    protected Predicate<String[]> getPredicate() {
        return line -> line[Column.TEAM_INPUT.sequentialNumber()].equals(Team.KYIV.value());
    }
}
