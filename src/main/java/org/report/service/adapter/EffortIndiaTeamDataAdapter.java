...
public class EffortIndiaTeamDataAdapter extends BaseEffortDataAdapter implements DataAdapter<EffortTeamData> {
    @Override
    protected Predicate<String[]> getPredicate() {
        return line -> line[Column.TEAM_INPUT.sequentialNumber()].equals(Team.INDIA.value());
    }
}
